...
public class NiceSpinner extends AppCompatTextView {
    ...
    private SimpleSpinnerTextFormatter spinnerTextFormatter = new SimpleSpinnerTextFormatter();
    private SimpleSpinnerTextFormatter selectedTextFormatter = new SimpleSpinnerTextFormatter();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.bg_spinner_selector);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_spinner_drawable));
        } else {
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.bg_spinner_arrow);
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.bg_spinner_arrow);
        setArrowDrawableOrHide(arrowDrawable);
    }
...
//        this.adapter = new NiceSpinnerAdapter(getContext(), ,adapter, textColor, backgroundSelector, spinnerTextFormatter);
//        setAdapterInternal(this.adapter);
//    }

    private void setAdapterInternal(NiceSpinnerAdapter adapter) {
