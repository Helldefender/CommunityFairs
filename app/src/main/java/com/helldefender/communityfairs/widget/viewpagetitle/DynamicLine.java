...
public class DynamicLine extends View {
    ...
    private void init() {
        ...
        paint.setShader(new LinearGradient(0, 100, DeviceUtil.getScreenWidth(getContext()), 100, Color.parseColor("#ffc125"), Color.parseColor("#ff4500"), Shader.TileMode.MIRROR));
    }
