package com.helldefender.enjoylife.widget.dialog;
...
public class EasyDialog extends Dialog {
	...
	public EasyDialog(Context context, int style, int layout) {
		super(context, style);
		mContext = context;
	...
	public EasyDialog(Context context, int layout, String msg) {
		this(context, R.style.easy_dialog_style, layout);
		setMessage(msg);
	}

	public EasyDialog(Context context, String msg) {
